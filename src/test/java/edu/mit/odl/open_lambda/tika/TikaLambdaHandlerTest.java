...
import edu.mit.odl.open_lambda.tika.TikaLambdaHandler;

/**
 * A simple test harness for locally invoking your Lambda function handler.
 */
@RunWith(MockitoJUnitRunner.class)
public class TikaLambdaHandlerTest {
    ...
    @Test
    public void testTikaLambdaHandler() {
        TikaLambdaHandler handler = new TikaLambdaHandler();
